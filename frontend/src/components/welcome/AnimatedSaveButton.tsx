...
export default function AnimatedSaveButton({
  ...
  return (
    <button
      ...
      className={`welcome-save-btn px-5 py-2.5 rounded-xl text-sm font-bold flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed bloom-btn ${btnAnim}`}
    >
      <span
        key={state}
